...
// $Rev: 17252 $
// File generated on 09.07.2009 10:06:52 from Type Library described below.

// ************************************************************************  //
// Type Lib: c:\Trade\TAccess\taccess.exe (1)
...
// *********************************************************************//
// Constants for enum __MIDL___MIDL_itf_TAccess_0000_0001
type
  __MIDL___MIDL_itf_TAccess_0000_0001 = TOleEnum;
const
  PutInQueue = $00000000;
  CancelBalance = $00000001;
  ImmOrCancel = $00000002;

// Constants for enum __MIDL___MIDL_itf_TAccess_0000_0003
type
  __MIDL___MIDL_itf_TAccess_0000_0003 = TOleEnum;
const
  Bid = $00000001;
  BidOrLast = $00000002;
  Ask = $00000003;
...
// Constants for enum __MIDL___MIDL_itf_TAccess_0000_0004
type
  __MIDL___MIDL_itf_TAccess_0000_0004 = TOleEnum;
const
  Absolute = $00000000;
  Percentage = $00000001;
  Combi = $00000002;
...
// *********************************************************************//
  ...
  OrderProperty = __MIDL___MIDL_itf_TAccess_0000_0001; 
  Condition = __MIDL___MIDL_itf_TAccess_0000_0003; 
  ChangeType = __MIDL___MIDL_itf_TAccess_0000_0004; 
...
// *********************************************************************//
  ITATrader = interface(IDispatch)
    ...
    procedure NewOrder(const bstrBoard: WideString; const bstrSecCode: WideString; 
                       ...
                       nOrderProp: OrderProperty; bSplit: WordBool; bUseCredit: WordBool; 
    ...
    procedure NewConditionalOrder(const bstrBoard: WideString; const bstrSecCode: WideString; 
                                  ...
                                  const bstrBrokerref: WideString; nOrderProp: OrderProperty; 
                                  bSplit: WordBool; bUseCredit: WordBool; bUseAltAcc: WordBool; 
                                  CancelAfterTime: OleVariant; Condition: Condition; 
    ...
    function GetSecurity(const bstrSecBoard: WideString; const bstrSecCode: WideString; 
                         Type_: ChangeType; var pbUpdated: OleVariant; var piResult: OleVariant; 
                         var pvarResult: OleVariant): ITARowset; safecall;
    ...
    function GetSecListAsFields(Type_: ChangeType; var pbUpdated: OleVariant; 
                                var piResult: OleVariant; var pvarResult: OleVariant): OleVariant; safecall;
...
// *********************************************************************//
  ITATraderDisp = dispinterface
    ...
    function GetSecurity(const bstrSecBoard: WideString; const bstrSecCode: WideString; 
                         Type_: ChangeType; var pbUpdated: OleVariant; var piResult: OleVariant; 
                         var pvarResult: OleVariant): ITARowset; dispid 7;
    function GetMarginPos(const bstrSecBoard: WideString; const bstrSecCode: WideString; 
                          const bstrClient: WideString; bIncludeConditional: WordBool; 
                          var pbDerivatives: OleVariant; var pType: OleVariant; 
